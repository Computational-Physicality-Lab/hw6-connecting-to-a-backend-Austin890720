...
const Header = ({ user }) => {
  ...
  return (
    <Container className="Header">
      ...
      <hr />
      <div className="menu">
        <Link to={routes.products} className="menu_Text">
          <p>T-SHIRTS</p>
        </Link>
        <Link to={routes.create} className="menu_Text">
          <p>CREATE FROM PICTURE</p>
        </Link>
        <Link to={routes.notImplemented} className="menu_Text">
          <p>CREATE YOUR OWN</p>
        </Link>
        <Link to={routes.notImplemented} className="menu_Text">
          <p>ABOUT US</p>
